...
import { createGestureClip, createMidiClip, configureTimeline, resetTimeline } from './movement/blendingEngine.js';
...
class App {
    ...
    _switchMode(key) {
        ...
        // Configure timeline step size for this mode
        // Step = how many px the playhead jumps right per new gesture
        const step = mode.gestureStep || 0;
        configureTimeline(step);
        resetTimeline();
